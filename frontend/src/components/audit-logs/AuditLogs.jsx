...
export default function AuditLogs() {
  ...
  const [auditLogs, setAuditLogs] = useState([
    ...
    },
    {
      ...
      entityId: "SC001",
      details: "New senior citizen 'Juan Dela Cruz' registered.",
    },
    {
      id: 3,
      ...
      entityType: "Pension",
      entityId: "P005",
      details: "Pension status for SC001 updated to 'Approved'.",
    },
    {
      id: 4,
      ...
      entityType: "User",
      entityId: "user456",
      details: "User 'old.staff@example.com' deleted.",
    },
    {
      id: 5,
      timestamp: "2024-05-29 14:45:00",
      user: "system",
      action: "SCHEDULED_TASK",
      entityType: "SMS",
      entityId: null,
      details: "Monthly SMS reminder sent to 150 senior citizens.",
    },
    {
      id: 6,
      timestamp: "2024-05-29 14:50:00",
      user: "staff@example.com",
      action: "VIEW",
      entityType: "Report",
      entityId: "RPT001",
      details: "Accessed 'Demographic Summary Report'.",
    },
    {
      id: 7,
      timestamp: "2024-05-29 14:55:00",
      user: "admin@example.com",
      action: "UPDATE",
      entityType: "Settings",
      entityId: "SMS_CONFIG",
      details: "SMS API Key updated.",
    },
    {
      id: 8,
    ...
    {
      id: 10,
      timestamp: "2024-05-29 15:10:00",
      user: "staff@example.com",
      action: "CREATE",
      entityType: "Benefit",
      entityId: "B010",
      details: "New benefit 'Medical Assistance' added.",
    },
  ]);
  ...
  //     setError("");
  //     try {
  //       const response = await axios.get('/api/audit-logs'); // Replace with your actual API endpoint
